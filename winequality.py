...
size = 4898#, 500, 1000]
# This winery has decided to group wines in three different categories.
# Low Quality
dataset.loc[dataset['quality'] < 4, 'quality'] = 0
# Mid Range
dataset.loc[(dataset['quality'] == 5) | (dataset['quality'] == 6) | (dataset['quality'] == 7), 'quality'] = 1
# High Quality
dataset.loc[dataset['quality'] > 7, 'quality'] = 2
...
# Attributes as described by the spreadsheet
...
# Create a 3 dimensional diagram showing a correlation between the attributes and quality in order to make an inference
fig = plt.figure()
